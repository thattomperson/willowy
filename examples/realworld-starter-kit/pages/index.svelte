      ...
      <div class="col-md-9">
        <div class="feed-toggle">
          <ul class="nav nav-pills outline-active">
            <li class="nav-item">
              <a class="nav-link disabled" href="#your-feed">Your Feed</a>
            </li>
            <li class="nav-item">
        ...
        <div class="article-preview">
          <div class="article-meta">
            ...
            <div class="info">
              <a href="/profile/eric" class="author">Eric Simons</a>
          ...
          <a href="/article/how-to-build" class="preview-link">
        ...
        <div class="article-preview">
          <div class="article-meta">
            ...
            <div class="info">
              <a href="/profile/albert" class="author">Albert Pai</a>
              <span class="date">January 20th</span>
            </div>
            <button class="btn btn-outline-primary btn-sm pull-xs-right">
